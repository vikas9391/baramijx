...
function ChatSection({ language }: SectionProps) {
  ...
  const content = {
    ar: {
      ...
      subtitle: 'اطرحوا أي سؤال عن برنامج عبد المنعم الزويني وحزب PML، وغادي تجاوبكم المساعدة الرقمية للحملة.',
      chatTitle: 'المستشار التفاعلي للمرشح عبد المنعم الزويني',
      liveChat: 'LIVE CHAT',
      greeting: 'مرحباً بكم يا أهل دائرتنا الأوفياء بمراكش المنارة. أنا المساعد الرقمي لعبد المنعم الزويني، رهن إشارتكم. سألوني على برنامجه في الصحة، فك العزلة عن العالم القروي، التعليم، أو رؤيته للسياسة القريبة من المواطن.',
    ...
    fr: {
      ...
      greeting: 'Bienvenue, citoyens de la circonscription de Marrakech-Menara. Je suis l\'assistant numérique d\'Abdelmounaim Zouini, à votre service. Posez-moi des questions sur son programme de santé, de lutte contre l\'isolement rural, d\'éducation, ou sa vision d\'une politique de proximité.',
    ...
    en: {
      ...
      subtitle: 'Ask anything about Abdelmounaim Zouini\'s program and the PML party, and the campaign\'s digital assistant will answer.',
      chatTitle: 'Interactive Advisor for Candidate Abdelmounaim Zouini',
      liveChat: 'LIVE CHAT',
      greeting: 'Welcome, dear citizens of Marrakech-Menara. I am the digital assistant for Abdelmounaim Zouini, at your service. Ask me about his healthcare plan, rural infrastructure, education, or his vision for proximity politics.',
